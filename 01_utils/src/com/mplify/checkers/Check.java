 ...
 *******************************************************************************
 *******************************************************************************
 * Function for checking parameters and throwing accordingly.
 * 
 ...
 * during parameter check ("Thrown to indicate that a method has been passed 
 ...
 * 2013.06.21 - Renamed "Check" to "Check" for consistency
 * 
 * TODO: Using printf format confuses and may be too specialized. There is the
 * alternative way of using '{}' placeholders in SLF4J strings, use that instead.
 ******************************************************************************/
...
public class Check {
    ...
    public static void isTrue(boolean x, String txt, Object... args) {
        if (!x) {
            throw new CheckFailedException(LogFacilities.formatForMe(txt, args));
        }
    }
    ...
    public static void cannotHappen(String txt, Object... args) {
        throw new Error("Can't happen: " + LogFacilities.formatForMe(txt, args));
    }
    ...
    public static void notNullAndInstanceOf(String name, Object obj, Class<?> clazz, String txt, Object... args) {
        ...
        if (!clazz.isAssignableFrom(obj.getClass())) {
            throw new CheckFailedException("The object '" + name + "' is not of class " + clazz.getName() + " but of class " + obj.getClass().getName() + ": " + LogFacilities.formatForMe(txt, args));
        }
    }
